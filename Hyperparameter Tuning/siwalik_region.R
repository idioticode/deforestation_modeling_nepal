...
saveRDS(best_models, file = "D:/MISC/Deforestation_modeling_rasters/Final_Models/best_models_siwalik.rds")
...
ggsave(
  'D:/MISC/Deforestation_modeling_rasters/Final_Images/SVG/siwalik_rf.svg',
  image,
  width = 12,
  height = 5
)
...
# Perform grid search
for (eta_val in c(0.2, 0.3)) { # o.01 and 0.001 are removed for the second tuning. 
